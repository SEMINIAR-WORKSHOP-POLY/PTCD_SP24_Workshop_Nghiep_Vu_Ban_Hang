...
public class ViewBanHang extends javax.swing.JFrame {
    ...
    private void tbSanPhamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbSanPhamMouseClicked
        ...
        // update tien trong o tien 
        txtTongTien.setText(showTotalMoney(listHoaDonChiTiets) + "");
    }//GEN-LAST:event_tbSanPhamMouseClicked
    
    private double showTotalMoney(List<HoaDonChiTietResponse> lists) {
        double sum = 0;
    ...
    private void btnThanhToanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThanhToanActionPerformed
        ...
        // tao 1 hoa don
        HoaDon hoaDon = new HoaDon(nguoiNhan, diaChi, sdt, Integer.valueOf(thanhTien));
        // update hoa don
